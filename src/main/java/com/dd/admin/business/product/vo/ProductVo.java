...
import com.dd.admin.business.product.dto.ImageDto;
 ...
 */
@Data
@ApiModel(value = "ProductVo对象", description = "商品Vo")
public class ProductVo {
    ...
    @ApiModelProperty(value = "首图ID（前端使用）")
    private String firstPictureId;

    @ApiModelProperty(value = "首图URL（前端使用）")
